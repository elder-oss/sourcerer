...
class DbstoreStreamVersionTest {
    @Test
    fun canFormatJdbcVersion() {
        val timestamp = Instant.parse("2018-12-24T12:01:02.123456789Z")
        val sequence = 425
        val streamVersion = DbstoreStreamVersion(timestamp, sequence).toStreamVersion()
    ...
    fun canParseJdbcVersion() {
        ...
        val jdbcVersion = streamVersion.toDbstoreStreamVersion()
