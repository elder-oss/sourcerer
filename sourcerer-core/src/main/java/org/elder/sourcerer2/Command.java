...
public interface Command<TState, TParams, TEvent> {
     ...
     * will fail with a {@link org.elder.sourcerer2.exceptions.UnexpectedVersionException} if the
     ...
     * {@link org.elder.sourcerer2.exceptions.UnexpectedVersionException}
