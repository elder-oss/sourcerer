...
/**
 * An aggregate state is a mutable representation of the state of an aggregate, along with events
 ...
 *
 * See also AggregateState for an immutable variation on this class.
 *
 ...
 */
public interface MutableAggregateState<TState, TEvent> {
    /**
     ...
     */
    void apply(Iterable<? extends TEvent> events);
    ...
    /**
     * Returns an immutable aggregate state from a snapshot of the current mutable state.
     * @return An immutable aggregate state.
     */
    AggregateState<TState, TEvent> toImmutable();
}
